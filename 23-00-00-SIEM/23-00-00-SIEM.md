...
| ------------------ | ------------------------------------------------------------ | -------------- | ------------------------------------------------------------ | ---------------- | ---------------- | ------------------------------------------------------------ | --------------------------------------------------------- |
| System             | Security State Change                                        | 4608           |                                                              | Success          | Security         | Windows is starting up                                       | 512                                                       |
| System             | Security System Extension                                    | 4610           |                                                              | Success          | Security         | An authentication package has been loaded by the Local Security Authority | 514                                                       |
| System             | System Integrity                                             | 4612           |                                                              | Success          | Security         | Internal resources allocated for the queuing of audit messages have been exhausted, leading to the loss of some audits | 516                                                       |
| System             | System Integrity                                             | 4615           |                                                              | Success          | Security         | Invalid use of LPC port                                      | 519                                                       |
...
| Logon/Logoff       | Logon                                                        | 4625           | \[AD\] Inventory, \[AD\] Failed Logins -> AD Failed Login Events | Failure          | Security         | An account failed to log on                                  | 529 , 530 , 531 , 532 , 533 , 534 , 535 , 536 , 537 , 539 |
| Object Access      | File System, Registry, SAM, Handle Manipulation, Other Object Access Events | 4656           | \[AD\] Removable Device Auditing                             | Success, Failure | Security         | A handle to an object was requested                          | 560                                                       |
| Object Access      | File System, Registry, Kernel Object, SAM, Other Object Access Events | 4663           | \[AD\] Removable Device Auditing                             | Success          | Security         | An attempt was made to access an object                      | 567                                                       |
| Object Access      | File System, Registry, Policy Change, Authorization Policy Change | 4670           | \[AD\] GPO Objects Overview                                  | Success          | Security         | Permissions on an object were changed                        |                                                           |
| Account Management | User Account Management                                      | 4720           | \[AD\] Accounts Overview -> \[AD\] A user account was created | Success          | Security         | A user account was created                                   | 624                                                       |
| Account Management | User Account Management                                      | 4722           | \[AD\] Accounts Overview ->\[AD\] A user account was disabled | Success          | Security         | A user account was enabled                                   | 626                                                       |
| Account Management | User Account Management                                      | 4723           | \[AD\] Accounts Overview ->\[AD\] An attempt was made to change an account's password | Success          | Security         | An attempt was made to change an account's password          | 627                                                       |
| Account Management | User Account Management                                      | 4724           | \[AD\] Accounts Overview ->\[AD\] An attempt was made to change an account's password | Success          | Security         | An attempt was made to reset an accounts password            | 628                                                       |
| Account Management | User Account Management                                      | 4725           | \[AD\] Accounts Overview ->\[AD\] A user account was disabled | Success          | Security         | A user account was disabled                                  | 629                                                       |
| Account Management | User Account Management                                      | 4726           | \[AD\] Accounts Overview ->\[AD\] A user account was deleted | Success          | Security         | A user account was deleted                                   | 630                                                       |
...
| Account Management | User Account Management                                      | 4740           | \[AD\] Accounts Overview ->AD Account - Account Locked       | Success          | Security         | A user account was locked out                                | 644                                                       |
...
| Account Management | User Account Management                                      | 4765           | \[AD\] Accounts Overview ->AD Account - Account History      | Success          | Security         | SID History was added to an account                          |                                                           |
| Account Management | User Account Management                                      | 4766           | \[AD\] Accounts Overview ->AD Account - Account History      | Failure          | Security         | An attempt to add SID History to an account failed           |                                                           |
