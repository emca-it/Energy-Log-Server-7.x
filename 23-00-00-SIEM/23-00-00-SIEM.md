...
License service configuration is required when using the SIEM Plan license. 

To configure the License Service, set the following parameters in the configuration file:
